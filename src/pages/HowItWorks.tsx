      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {steps.map((step, index) => (
              <div key={index} className="relative">
                <Card className="text-center hover:shadow-lg transition-all duration-300 hover-scale h-full">
                  <CardHeader>
                    <div className="relative mb-4">
                      <div className="absolute -top-4 -right-4 bg-teal-600 text-white text-sm font-bold w-8 h-8 rounded-full flex items-center justify-center">
                        {step.number}
                      </div>
        ...
        <section className="mb-20">
          ...
          <Card className="max-w-4xl mx-auto text-center py-12">
            <CardContent>
              <Award className="h-16 w-16 text-teal-600 mx-auto mb-6" />
        ...
        <section className="mt-20 text-center">
          <div className="bg-teal-50 p-12 rounded-lg">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              ...
              <Button size="lg" variant="outline" className="text-teal-600 border-teal-600 hover:bg-teal-50">
                Request Information
              </Button>
            </div>
          </div>
