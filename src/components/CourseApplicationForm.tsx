...
import { Upload, Send, User, MapPin, FileText, Eye, Shield } from "lucide-react";
...
const CourseApplicationForm = ({ children }: CourseApplicationFormProps) => {
  ...
  const uploadFile = async (file: File): Promise<string> => {
    ...
    // Use user ID as folder name for security
        ...
        <DialogContent className="max-w-4xl max-h-[90vh] overflow-y-auto">
          <DialogHeader>
            <DialogTitle className="text-2xl font-bold text-gray-900 flex items-center gap-2">
              ...
              <Shield className="h-5 w-5 text-green-500" title="Secure Form" />
            </DialogTitle>
            <DialogDescription className="text-gray-600">
              Please fill out all required information to apply for the Certified Contemporary Management course.
              <br />
              <span className="text-green-600 font-medium">🔒 This form is secured with encryption and authentication.</span>
            </DialogDescription>
          </DialogHeader>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <p className="text-sm text-gray-500">
                    ...
                    <br />
                    <span className="text-green-600">🔒 Files are encrypted and stored securely</span>
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-end">
                <Button 
                  type="submit"
                  size="lg"
                  disabled={!termsAccepted || isSubmitting || !user}
